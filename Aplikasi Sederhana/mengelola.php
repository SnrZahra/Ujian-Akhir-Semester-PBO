...
<body>
      <div class="container">
        <h2 class="text-center">FORM INPUT DATA MAHASISWA UNESA</h2>
        <br>
        <form method="POST" action="proses.php" class="font-weight-bold">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="nim" class="form-control" id="Nim" placeholder="contoh: 20051214090" required value="<?php echo $nim; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="namamhs" class="form-control" id="Namamhs" placeholder="contoh: Febri Tri Prasetyo" required value="<?php echo $namamhs; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text"  name="alamat" class="form-control" id="Alamat" placeholder="Contoh: Dusun Jenggolo RT 02 RW 09 Desa Bejagung" required value="<?php echo $alamat; ?>">
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="kota" class="form-control" id="Kota" placeholder="contoh: Tuban" required value="<?php echo $kota; ?>">
                </div>
            </div>
